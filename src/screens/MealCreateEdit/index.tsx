...
export function MealCreateEdit({}: IMealCreate) {
	const [dietOk, setDietOk] = useState<string>('1');
	const [form, setForm] = useState<IForm>({
    name: '',
    description: '',
    date: '',
    hour: '',
    isDiet: true, // Aqui a dieta por padrão é "sim"
  });
        ...
        />
          ...
          <S.InputContent>
            ...
            >
				...
				<Button type="PRIMARY" title="Cadastrar refeição" onPress={handleButtonOnFinish}/>
			</S.Content>
		</S.Conteiner>
	);
}
